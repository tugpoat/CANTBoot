					...
					<div class="form-group">
						<label class="col-sm-2 control-label">Enable fastboot</label>
						<div class="col-sm-1">
							<input type="checkbox" class="form-control" name="fastboot_enable" {{fastboot_enable}} />
						</div>
					</div>
